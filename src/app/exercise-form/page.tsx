...
import { FormState, submitTravelDataBasic, type TravelData } from "./actions";
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  {state.submittedData?.birthdate}
                </div>
                <div>
                  <Label>Passport:</Label>
                  {state.submittedData?.passport}
                </div>
                <div>
                  <Label>Origin:</Label>
                  {
                    locations.find(
                      (loc) => loc.value === state.submittedData?.originCity
                    )?.label
                  }
                </div>
                <div className="md:col-span-2">
                  <Label>Seat Preference:</Label>
                  {
                    seatPreferences.find(
                      (seat) =>
                        seat.value === state.submittedData?.seatPreference
                    )?.label
                  }
                </div>
              </div>
